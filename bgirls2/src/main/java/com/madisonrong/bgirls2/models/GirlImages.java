...
public class GirlImages {
    ...
    public GirlImages(String title, String intro, String comment, String width, String height, String thumb_50, String thumb_160, String image_url, String createtime, String source, int id) {
        this.title = title;
        this.intro = intro;
